namespace ColorAdjustmentsMod.Mod
{
    ...
    public sealed class Mod : IMod
    {
        ...
        public void OnCreateWorld(UpdateSystem updateSystem)
        {
            ...
            UnityEngine.Debug.Log("ColorAdjustments exported settings located at:" + AppDomain.CurrentDomain.BaseDirectory); // Exports mod settings to an additional file on load.
            string assemblyDirectory = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "ColorAdjustments.xml");
            GlobalVariables.LoadFromFile(assemblyDirectory);
