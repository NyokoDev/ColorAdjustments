...
namespace ReRenderingOptions
{
    ...
    public static class Localization
    {
        ...
        public static void LoadTranslations(ModSetting settings, ILog log)
        {
            ...
            {
                // Read embedded file.
                using StreamReader reader = new(Assembly.GetExecutingAssembly().GetManifestResourceStream("ColorAdjustments.l10n.csv"));
                {
        ...
        private static string GenerateOptionsKey(string context, string key, ModSetting settings)
        {
            return context switch
            {
                ...
                "Options.TAB" => settings.GetOptionTabLocaleID(key), // Assuming key represents tabName here
                "Options.GROUP" => settings.GetOptionGroupLocaleID(key), // Assuming key represents groupName here
